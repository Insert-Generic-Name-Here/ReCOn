...
class ProcessMonitor(object):
    ...
    def __MonitorCPU(self, mostImportant=10):
        ...
        print (f'@CPUMonitor -> {time.time()-STARTING_TIME} seconds')
    ...
    def MonitorDaemon(self, nvGpuFlag=False, logData=False):
        ...
        while True:
            ...
            if (nvGpuFlag):
                ...
                runningProcs = self.__JoinRunningProcesses(cpuProcs, gpuProcs)
            else:
